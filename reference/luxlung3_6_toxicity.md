...
This dataset contains simulated toxicity data pooled from the LUX‑Lung 3
and LUX‑Lung 6 randomized clinical trials (RCTs), including both
any‑grade (G1–4) and severe (G3–4) adverse events. It also includes
patient‑reported quality of life (QoL) scores stored in the `qol`
