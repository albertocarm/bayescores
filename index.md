...
![](reference/figures/README-simulate-data-1.png)
...
![](reference/figures/README-plot_any_grade_toxicity-1.png)
...
![](reference/figures/README-plot_severe_toxicity-1.png)
...
![](reference/figures/README-mcmc_plots-1.png)
...
![Figure 1: Posterior density distributions for Time Ratio, Odds Ratio
of Cure, and Cure Probability
Difference.](reference/figures/README-plot-parameters-1.png)
...
Ratio of Cure](reference/figures/README-plot-joint-1.png)
...
![Figure 3: Posterior predictive check (model vs Kaplan-Meier
data).](reference/figures/README-plot-model-fit-1.png)
...
![Figure 5: Multinomial distribution of QoL
levels.](reference/figures/README-qol-weighting-1.png)
...
![Figure 6: BayeScore donut
plot.](reference/figures/README-plot-donut-1.png)
...
![Figure 7: Final BayeScore posterior
distribution.](reference/figures/README-plot-score-density-1.png)
...
![](reference/figures/README-apply_shrinkage-1.png)

``` r
plot_utility_donut(final_scores_sherry, trial_name ="sherry's shrinkage")
```

![](reference/figures/README-apply_shrinkage-2.png)
...
![](reference/figures/README-sensitivity-dashboard-1.png)
...
![](reference/figures/README-monaleesa-2-1.png)
...
![](reference/figures/README-ipd-1.png)
